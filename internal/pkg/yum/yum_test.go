...
func TestManager_Install_SinglePackage(t *testing.T) {
	...
	assert.True(t, mockExec.WasCalled("yum"))
...
func TestManager_Install_WithOptions(t *testing.T) {
	...
	lastCall := mockExec.LastCall()
	assert.Contains(t, lastCall.Args, "--skip-broken") // YUM uses --skip-broken for Force
...
func TestManager_Install_PackageNotFound(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "No package nonexistent available."))
...
func TestManager_Install_NothingToDo(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Nothing to do"))
...
func TestManager_Install_GenericError(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Some unknown error"))
...
func TestManager_Remove_GenericError(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Some generic error"))
...
func TestManager_Remove_NoPackagesMarked(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "No Packages marked for removal"))
...
func TestManager_Update_Success(t *testing.T) {
	...
	// yum check-update returns 0 when no updates available
	mockExec.SetResponse("yum", exec.SuccessResult(""))
...
func TestManager_Update_GenericFailure(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Some error"))
...
func TestManager_Upgrade_AllPackages(t *testing.T) {
	...
	lastCall := mockExec.LastCall()
	// YUM uses "update" instead of "upgrade"
...
func TestManager_Upgrade_Failure(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Upgrade failed"))
...
Installed Packages
nginx.x86_64    1.22.0-1.el7    @epel`
...
func TestManager_Search_NoResults(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Warning: No matches found"))
...
func TestManager_Search_Failure(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Database error"))
...
Repo        : epel`
	...
	assert.Equal(t, "1.22.0-1.el7", info.Version)
...
func TestManager_Info_NotFound(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Error: No matching Packages to list"))
...
vim-minimal	7.4.629-8.el7	x86_64`
...
curl.x86_64                     7.29.0-60.el7              base`

	// Exit code 100 means updates available - output goes to stdout
	mockExec.SetResponse("yum", exec.SuccessResultWithStderr(output, ""))
	...
	assert.Equal(t, "epel", packages[0].Repository)
}
...
func TestManager_ListUpgradable_Failure(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Check update failed"))
...
func TestManager_Clean_Success(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.SuccessResult("Cleaning repos"))
...
func TestManager_Clean_Failure(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Clean failed"))

	err := mgr.Clean(context.Background())
	require.Error(t, err)
	assert.Contains(t, err.Error(), "yum clean failed")
}
...
func TestManager_AutoRemove_Success(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.SuccessResult("Removing unused packages"))
...
func TestManager_AutoRemove_FallbackToPackageCleanup(t *testing.T) {
	mgr, mockExec := setupTest()
...
func TestManager_AddEPEL_CentOS(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetResponse("yum", exec.SuccessResult("Complete!"))

	err := mgr.AddEPEL(context.Background())
	require.NoError(t, err)

	lastCall := mockExec.LastCall()
	assert.Contains(t, lastCall.Args, "install")
	assert.Contains(t, lastCall.Args, "epel-release")
}

func TestManager_AddEPEL_RHELFallback(t *testing.T) {
	mgr, mockExec := setupTest()

	// First attempt (epel-release package) fails
	// Second attempt (direct URL) succeeds
	callCount := 0
	mockExec.SetDefaultResponse(exec.SuccessResult(""))

	// The mock will return success for both calls, simulating RHEL fallback succeeding
	err := mgr.AddEPEL(context.Background())
	require.NoError(t, err)
	_ = callCount
}

func TestManager_AddEPEL_AlreadyInstalled(t *testing.T) {
	mgr, mockExec := setupTest()

	// First call fails, second call shows already installed
	mockExec.SetResponse("yum", exec.FailureResult(0, "Package epel-release already installed"))
...
func TestManager_AddRepository_FromURL(t *testing.T) {
	...
	repo := pkg.Repository{
		Name: "nvidia",
		URL:  "https://developer.download.nvidia.com/cuda/rhel7/x86_64/cuda-rhel7.repo",
	}
	...
	lastCall := mockExec.LastCall()
	assert.Equal(t, "yum-config-manager", lastCall.Command)
...
func TestManager_AddRepository_AlreadyExists(t *testing.T) {
	...
	mockExec.SetResponse("yum-config-manager", exec.FailureResult(1, "repository already exists"))
...
repolist: 10000`
	...
	assert.Equal(t, "base", repos[0].Name)
...
func TestManager_ListRepositories_Failure(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Repolist failed"))
...
func TestManager_EnableRepository_Success(t *testing.T) {
	...
	err := mgr.EnableRepository(context.Background(), "nvidia-cuda")
	require.NoError(t, err)

	lastCall := mockExec.LastCall()
	assert.Equal(t, "yum-config-manager", lastCall.Command)
	assert.Contains(t, lastCall.Args, "--enable")
	assert.Contains(t, lastCall.Args, "nvidia-cuda")
}

func TestManager_EnableRepository_NotFound(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetResponse("yum-config-manager", exec.FailureResult(1, "Error: No matching repo"))
...
func TestManager_DisableRepository_Success(t *testing.T) {
	...
	err := mgr.DisableRepository(context.Background(), "nvidia-cuda")
	require.NoError(t, err)
...
func TestManager_RefreshRepositories_Success(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.SuccessResult("Metadata cache created"))
...
func TestManager_RefreshRepositories_NetworkError(t *testing.T) {
	...
	mockExec.SetResponse("yum", exec.FailureResult(1, "Cannot retrieve metalink for repository"))
...
func TestManager_RefreshRepositories_GenericError(t *testing.T) {
	...
	err := mgr.RefreshRepositories(context.Background())
	require.Error(t, err)
	assert.Contains(t, err.Error(), "yum makecache failed")
}
...
func TestManager_AddRPMFusionEL_AlreadyInstalled(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetResponse("yum", exec.FailureResult(1, "Package rpmfusion-free-release already installed"))

	err := mgr.AddRPMFusionEL(context.Background(), true, false)
	require.NoError(t, err) // Already installed is not an error
}
...
func TestManager_InstallYumUtils(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetResponse("yum", exec.SuccessResult("Complete!"))

	err := mgr.InstallYumUtils(context.Background())
	require.NoError(t, err)

	lastCall := mockExec.LastCall()
	assert.Contains(t, lastCall.Args, "yum-utils")
}

func TestManager_AddNvidiaRepo(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetResponse("yum-config-manager", exec.SuccessResult(""))

	err := mgr.AddNvidiaRepo(context.Background())
	require.NoError(t, err)
}

func TestManager_AddElrepo(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetDefaultResponse(exec.SuccessResult("Complete!"))

	err := mgr.AddElrepo(context.Background())
	require.NoError(t, err)
}

func TestManager_AddElrepo_AlreadyInstalled(t *testing.T) {
	mgr, mockExec := setupTest()

	mockExec.SetResponse("rpm", exec.SuccessResult(""))
	mockExec.SetResponse("yum", exec.FailureResult(1, "Package elrepo-release already installed"))
...
func TestParseYumInfo(t *testing.T) {
	output := `Name        : nginx
Version     : 1.22.0
Release     : 1.el7
Arch        : x86_64
...
func TestParseYumSearch_WithLoadedPlugins(t *testing.T) {
	output := `Loaded plugins: fastestmirror
...
curl.x86_64                     7.29.0-59.el7              @base`
	...
	packages, err := parseYumList(output)
	require.NoError(t, err)
	require.Len(t, packages, 2)
...
func TestParseYumRepolist(t *testing.T) {
	output := `Loaded plugins: fastestmirror
repo id                           repo name                                 status
base/7/x86_64                     CentOS-7 - Base                           enabled
epel/x86_64                       Extra Packages for Enterprise Linux 7     enabled
...
repolist: 10000`
	...
	repos, err := parseYumRepolist(output)
	require.NoError(t, err)
	require.Len(t, repos, 3)
	...
	assert.Equal(t, "nvidia-cuda", repos[2].Name)
	assert.False(t, repos[2].Enabled)
}

func TestParseYumRepolist_Empty(t *testing.T) {
	repos, err := parseYumRepolist("")
	require.NoError(t, err)
...
func TestParseYumCheckUpdate_WithMetadata(t *testing.T) {
	output := `Loaded plugins: fastestmirror
nginx.x86_64                    1.24.0-1.el7               epel
Security: kernel.x86_64         3.10.0-1160.el7            base`
...
gpgcheck=1`
	...
	assert.True(t, repos[0].Enabled)
	assert.Equal(t, "https://developer.download.nvidia.com/cuda/repos/rhel7/x86_64/7fa2af80.pub", repos[0].GPGKey)
...
func TestBuildRepoFileContent(t *testing.T) {
	...
	assert.Contains(t, content, "gpgkey=https://developer.download.nvidia.com/cuda/repos/rhel7/x86_64/7fa2af80.pub")
}
